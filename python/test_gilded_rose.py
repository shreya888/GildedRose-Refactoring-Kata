...
class GildedRoseTest(unittest.TestCase):
    def test_update_item(self):
        ...
        self.assert_sulfuras_values(Item("Sulfuras, Hand of Ragnaros", 10, 40))
        self.assert_sulfuras_values(Item("Sulfuras, Hand of Ragnaros", 10, 80))
        self.assert_item_values(Item("Backstage passes to a TAFKAL80ETC concert", 10, 10), 12)
        self.assert_item_values(Item("Backstage passes to a TAFKAL80ETC concert", 5, 10), 13)
        self.assert_item_values(Item("Backstage passes to a TAFKAL80ETC concert", 0, 10), 0)
